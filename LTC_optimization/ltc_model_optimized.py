...
class LTCCell(nn.Module):
    ...
    def __init__(self, input_size, num_units, solver=ODESolver.SemiImplicit, solver_clip=5.0, backend='torch'):
    ...
    def _ode_step_semi_implicit(self, inputs, state):
        ...
        if self.backend == 'torch':
            ...
            v_pre_out = ode_step_forward_triton(
                ...
                self.cm_t, self.gleak, self.vleak,
                unfolds=self._ode_solver_unfolds
            )
            return v_pre_out
